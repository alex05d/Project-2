...
​
    CREATE TABLE pets(
    pets_id INT AUTO_INCREMENT NOT NULL,
    owner_id INT NOT NULL,
    pets_name VARCHAR(30) NOT NULL,
    pet_type VARCHAR(30) NOT NULL,
    pet_weight INT NOT NULL,
    pet_birthday VARCHAR(30) NOT NULL,
...
CREATE TABLE pet_feeding(
    feeding_id INT AUTO_INCREMENT NOT NULL,
    pet_id INT NOT NULL,
    pet_food VARCHAR(30) NOT NULL,
...
​
    ...
    medication_time VARCHAR(40),
    dosage VARCHAR(40),
    PRIMARY KEY(med_id),
    FOREIGN KEY(pets_id) REFERENCES pets(pets_id) ON DELETE CASCADE
);
​
    CREATE TABLE appointments(
    appt_id INT AUTO_INCREMENT NOT NULL,
    pet_id INT NOT NULL,
    vet_name VARCHAR(40) NOT NULL,
    vet_address VARCHAR(40) NOT NULL,
    appt DATETIME,
    PRIMARY KEY(appt_id),
    FOREIGN KEY(pets_id) REFERENCES pets(pets_id)
);
